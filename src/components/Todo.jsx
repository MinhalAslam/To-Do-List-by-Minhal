...
useEffect(()=>{
  ...
  return (
    <div className='bg-sky-400 place-self-center w-11/12 max-w-md flex 
...
{/* -----input box------- */}
    ...
    <div className='flex items-center my-7 bg-gray-200 rounded-full'>
        ...
        <button onClick={add} className='border-none rounded-full bg-purple-600 w-32 h-14 text-white 
